...
import com.example.pomodoro.widget.CutoutDrawable;
import com.example.pomodoro.widget.TransformedDrawable;
...
public class CropImageView extends AppCompatImageView {
	...
	private static int getMaximumTextureSize()
	{
		...
		Log.i(AppLog.TAG, "Maximum GL texture size: " + maximumTextureSize);
