...
import com.example.pomodoro.adapter.ResultPodAdapter;
import com.example.pomodoro.api.GoogleCustomSearchAPI;
import com.example.pomodoro.api.MicrosoftCognitiveAPI;
import com.example.pomodoro.api.WolframAlphaAPI;
import com.example.pomodoro.contentprovider.SearchSuggestionProvider;
import com.example.pomodoro.model.ResultPod;
...
public class myActivity extends BaseActivity implements ActivityCompat.OnRequestPermissionsResultCallback, FrameReturn {
    ...
    public void callhome(View view) {
        Intent intent2 = new Intent(myActivity.this, Pomodoro.class);
