...
public class Utils {
    ...
    public static final String WOLFRAM_APP_ID = "KTTXPR-3947JVH2XL";
    public static final String WOLFRAM_BASE_URL = "http://api.wolframalpha.com/v2/query?";

    // Microsoft Cognitive API

    public static final String MS_IMAGE_SEARCH_SUBSCRIPTION_KEY = "e56512ecd0c64a6bafa643c7b35ce3c3";
    public static final String MS_COMPUTER_VISION_SUBSCRIPTION_KEY = "e56512ecd0c64a6bafa643c7b35ce3c3";
